Title: hermes-mcp — drive your Hermes install from Claude Code, Cursor or any MCP client
...
Repo: https://github.com/woonyong-choi/hermes-mcp
Install: `uvx hermes-mcp` (or `claude mcp add hermes -- uvx hermes-mcp`)

Why I made it: I run Hermes on a MacBook and drive it from Telegram, but the agents I use for coding live elsewhere and had no way to touch Hermes without me typing in a terminal. There are plenty of Telegram MCPs; there wasn't one that operates Hermes itself.
